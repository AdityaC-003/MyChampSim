...
def main():
    ...
    for replacement_policy in replacement_policies:
        ...
        key_list = ['astar_313B', 'bzip2_281B', 'bwaves_1609B', 'cactusADM_1495B', 'h264ref_178B', 'lbm_126B', 'leslie3d_1186B', 'libquantum_964B', 'soplex_271B', 'xalancbmk_99B']
